 ...
 * license information.
 */
package com.example.calendarpart;
...
public class DayView extends ViewGroup {
    ...
    @NonNull
    @VisibleForTesting
    final List<com.example.calendarpart.DirectionalRect> hourLabelRects;
    @NonNull
    @VisibleForTesting
    final List<com.example.calendarpart.DirectionalRect> hourDividerRects;
    @NonNull
    @VisibleForTesting
    final List<com.example.calendarpart.DirectionalRect> halfHourDividerRects;
    @NonNull
    @VisibleForTesting
    ...
    @NonNull
    @VisibleForTesting
    final List<com.example.calendarpart.DirectionalRect> eventRects;
    ...
    DayView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, boolean enableDrawing) {
        ...
        for (int i = 0; i < hourDividersCount; i++) {
            hourDividerRects.add(new com.example.calendarpart.DirectionalRect());
        }

        halfHourDividerRects = new ArrayList<>(halfHourDividersCount);
        for (int i = 0; i < halfHourDividersCount; i++) {
            halfHourDividerRects.add(new com.example.calendarpart.DirectionalRect());
        }

        hourLabelRects = new ArrayList<>(hourLabelsCount);
        for (int i = 0; i < hourLabelsCount; i++) {
            hourLabelRects.add(new com.example.calendarpart.DirectionalRect());
        }
    ...
    public void setEventViews(@Nullable List<View> eventViews,
        ...
        if (!this.filteredEventViews.isEmpty() && !this.filteredEventTimeRanges.isEmpty()) {
            ...
            for (View view : this.filteredEventViews) {
                addView(view);
                eventRects.add(new com.example.calendarpart.DirectionalRect());
            }
        }
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        for (int i = 0; i < hourLabelViews.size(); i++) {
            ...
            com.example.calendarpart.DirectionalRect rect = hourLabelRects.get(i);
        ...
        for (int i = 0; i < filteredEventViews.size(); i++) {
            ...
            com.example.calendarpart.DirectionalRect rect = eventRects.get(i);
            view.layout(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom());
        }
    }
    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        for (com.example.calendarpart.DirectionalRect rect : hourDividerRects) {
        ...
        for (com.example.calendarpart.DirectionalRect rect : halfHourDividerRects) {
            canvas.drawRect(rect.getLeft(),
                    rect.getTop(),
                    rect.getRight(),
                    rect.getBottom(),
    ...
    protected void measureExactly(@NonNull View view, @NonNull com.example.calendarpart.DirectionalRect rect) {
     ...
     */
    protected void setRect(@NonNull com.example.calendarpart.DirectionalRect rect, int start, int top, int end, int bottom) {
     ...
     */
    @NonNull
    protected List<com.example.calendarpart.DirectionalRect> getHourDividerRects() {
     ...
     */
    @NonNull
    protected List<com.example.calendarpart.DirectionalRect> getHalfHourDividerRects() {
