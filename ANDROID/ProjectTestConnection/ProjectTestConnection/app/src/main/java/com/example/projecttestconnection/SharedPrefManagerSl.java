...
public class SharedPrefManagerSl {
    private static final String SHARED_PREF_NAME = "SALARIE_PART";
    ...
    private static SharedPrefManagerSl mInstance;
    private static Context mCtx;

    private SharedPrefManagerSl(Context context) {
        mCtx = context;
    }

    public static synchronized SharedPrefManagerSl getInstance(Context context) {
        if (mInstance == null) {
            mInstance = new SharedPrefManagerSl(context);
        }
        return mInstance;
    }
